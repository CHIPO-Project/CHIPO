Contributing to CHIPO Core
============================

The CHIPO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CHIPO Core project, and is not to be
confused with overall CHIPO Network Protocol consensus changes.

Whether a pull request is merged into CHIPO Core rests with the project merge
...
Patches that change CHIPO consensus rules are considerably more involved than
...
Where a patch set proposes to change the CHIPO consensus, it must have been
...
The project leader is the release manager for each CHIPO Core release.
