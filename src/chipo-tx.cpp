...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CHIPO Core chipo-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  chipo-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded chipo transaction") + "\n" +
                               "  chipo-tx [options] -create [commands]   " + _("Create hex-encoded chipo transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded chipo transaction
