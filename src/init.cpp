...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-reindexmoneysupply", _("Reindex the ICU and zICU money supply statistics") + " " + _("on startup"));
    ...
    if (GetBoolArg("-help-debug", false))
        strUsage += HelpMessageOpt("-mintxfee=<amt>", strprintf(_("Fees (in ICU/Kb) smaller than this are considered zero fee for transaction creation (default: %s)"),
            FormatMoney(CWallet::minTxFee.GetFeePerK())));
    strUsage += HelpMessageOpt("-paytxfee=<amt>", strprintf(_("Fee (in ICU/kB) to add to transactions you send (default: %s)"), FormatMoney(payTxFee.GetFeePerK())));
    ...
    strUsage += HelpMessageOpt("-minrelaytxfee=<amt>", strprintf(_("Fees (in ICU/Kb) smaller than this are considered zero fee for relaying (default: %s)"), FormatMoney(::minRelayTxFee.GetFeePerK())));
...
//    strUsage += "  -anonymizechipoamount=<n>     " + strprintf(_("Keep N ICU anonymized (default: %u)"), 0) + "\n";
...
//    if (nAnonymizeCHIPOAmount < 2) nAnonymizeCHIPOAmount = 2;
    ...
    /* Denominations
       ...
       For example:
       1ICU+1000 == (.1ICU+100)*10
       10ICU+10000 == (1ICU+1000)*10
    */
