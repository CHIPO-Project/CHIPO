...
/** Utility functions used by the CHIPO Qt UI.
 */
namespace GUIUtil
{
...
// Render CHIPO addresses in monospace font
...
// Parse "chipo:" URI into recipient object, return true on successful parsing
