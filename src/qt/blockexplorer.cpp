...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::MTNS, nValue);
...
{
    std::string genesisblockhash = "0000057a372928aa35f432dc3bd5c58275a0219e7743eea71ad3ffd6f7e78b85";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (chipo.conf).");
            QMessageBox::warning(this, "CHIPO Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#ff9900;}\n a, span { font-family: monospace; }\n span.addr {color:#ff9900; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #ff9900;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#ff9900;}\n a { color:#88f6f6; text-decoration:none; }\n a.nav {color:#ff9900;}\n";
