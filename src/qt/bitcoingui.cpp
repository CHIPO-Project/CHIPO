                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CHIPO Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CHIPO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and chipo: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMTNS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CHIPO Core"), this);
    aboutAction->setStatusTip(tr("Show information about CHIPO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CHIPO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CHIPO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CHIPO addresses"));
	...
	*/
    ...
    openAction->setStatusTip(tr("Open a CHIPO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CHIPO Core help message to get a list with possible CHIPO command-line options"));
...
//        toolbar->setIconSize(QSize(40,40)); // todoKANI
        toolbar->setIconSize(QSize(120,40)); // todoKANI
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CHIPO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CHIPO network", "", count));
}
...
{
    QString strTitle = tr("CHIPO Core"); // default title
