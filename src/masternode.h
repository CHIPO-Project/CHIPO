...
#define MASTERNODE_MIN_MTNS_SECONDS (10 * 60)
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 MTNS, signature to prove
