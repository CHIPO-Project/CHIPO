 ...
 * CHIPO system. There are three: the main network on which people trade goods
...
public:
    ...
    int MASTERNODE_COLLATERAL() const { return nMasternodeCollateral; }
    ...
    int LAST_POW_BLOCK_OFFSET() const { return nLastPOWBlockOffset; }
    ...
    int CurrentHeaderVersion() const { return nCurrentHeaderVersion; }
