...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in chipo\n"
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zMTNSsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zMTNS denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zMTNS denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zMTNS denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zMTNS denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zMTNS denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zMTNS denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zMTNS denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zMTNS denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zMTNS denominations\n"
            "  }\n"
            "}\n"
            "\nResult (for verbose=false):\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of chipo addresses\n"
            "     \"chipoaddress\"   	 	(string) chipo address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
