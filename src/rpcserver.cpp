...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CHIPO features */
        {"chipo", "masternode", &masternode, true, true, false},
        {"chipo", "listmasternodes", &listmasternodes, true, true, false},
        {"chipo", "getmasternodecount", &getmasternodecount, true, true, false},
        {"chipo", "masternodeconnect", &masternodeconnect, true, true, false},
        {"chipo", "masternodecurrent", &masternodecurrent, true, true, false},
        {"chipo", "masternodedebug", &masternodedebug, true, true, false},
        {"chipo", "startmasternode", &startmasternode, true, true, false},
        {"chipo", "createmasternodekey", &createmasternodekey, true, true, false},
        {"chipo", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"chipo", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"chipo", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"chipo", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"chipo", "getmasternodescores", &getmasternodescores, true, true, false},
        {"chipo", "mnbudget", &mnbudget, true, true, false},
        {"chipo", "preparebudget", &preparebudget, true, true, false},
        {"chipo", "submitbudget", &submitbudget, true, true, false},
        {"chipo", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"chipo", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"chipo", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"chipo", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"chipo", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"chipo", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"chipo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"chipo", "checkbudgets", &checkbudgets, true, true, false},
        {"chipo", "mnsync", &mnsync, true, true, false},
        {"chipo", "spork", &spork, true, true, false},
        {"chipo", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"chipo", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> chipo-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:32180/\n";
}
