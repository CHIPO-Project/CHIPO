...
In order to support loading of multiple wallets in chipo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is chipo.cpp.
...
Changes to chipo.cpp
----------------------
chipo.cpp is the entry point into chipo-qt, and as such, will require some minor modifications to provide hooks for
