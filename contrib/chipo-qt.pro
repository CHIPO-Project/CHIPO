...
RESOURCES += src/qt/chipo.qrc src/qt/chipo_locale.qrc

TRANSLATIONS += src/qt/locale/chipo_bg.ts \
                src/qt/locale/chipo_de.ts \
                src/qt/locale/chipo_en.ts \
                src/qt/locale/chipo_es.ts \
                src/qt/locale/chipo_fi.ts \
                src/qt/locale/chipo_fr.ts \
                src/qt/locale/chipo_it.ts \
                src/qt/locale/chipo_ja.ts \
                src/qt/locale/chipo_pl.ts \
                src/qt/locale/chipo_pt.ts \
                src/qt/locale/chipo_ru.ts \
                src/qt/locale/chipo_sk.ts \
                src/qt/locale/chipo_sv.ts \
                src/qt/locale/chipo_vi.ts \
                src/qt/locale/chipo_zh_CN.ts \
                src/qt/locale/chipo_zh_TW.ts
