...
This means one can have an always-on chipod instance running, and another local chipod/chipo-qt instance which connects to this node and receives blocks from it.
